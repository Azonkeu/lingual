...
## GilorSpeak with React and Redux

In this project, we will build the GilorSpeak app which is a platform connecting students with native English speakers for language lessons. 
...
This project is [MIT](https://github.com/Azonkeu/lingual/blob/develop/LICENSE) licensed.
